...
describe 'mollyguard::checks::repmgr_postgres' do
  let :default_params do
    { destination: '/tmp/test',
      check_name: 'repmgr_postgres-molly-test',
      sort: '20',
      owner: 'root',
      group: 'root',
      mode: '0755' }
  ...
  shared_examples 'mollyguard::checks::repmgr_postgres define' do
  ...
  on_supported_os.each do |os, os_facts|
    context "on #{os}" do
      ...
      context 'whith defaults' do
        ...
        it_behaves_like 'mollyguard::checks::repmgr_postgres define'
      end
