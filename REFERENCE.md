...
* [`mollyguard::checks::rabbitmq`](#mollyguardchecksrabbitmq): use this to add drbd check to molly-guard
...
### <a name="mollyguardchecksrabbitmq"></a>`mollyguard::checks::rabbitmq`
